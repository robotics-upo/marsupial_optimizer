...
class MarkerPublisher
{
	public:
		MarkerPublisher(){};
		~MarkerPublisher(){};
		void markerPoints(visualization_msgs::MarkerArray _marker, std::vector<geometry_msgs::Vector3> _vector, int _suffix, int _n_v, ros::Publisher c_m_pub_, int change_marker_= 0, bool print_ = false);
