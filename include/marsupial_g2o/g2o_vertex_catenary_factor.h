...
#ifndef G2O_VERTEX_CATENARY_FACTOR_H
#define G2O_VERTEX_CATENARY_FACTOR_H
...
/**
  ...
  */
class VertexCatenaryFactor : public g2o::BaseVertex<1, double>
{
public:
  ...
  /**
    ...
    */  
  VertexCatenaryFactor(bool fixed = false)
  {
    setToOriginImpl();
    setFixed(fixed);
  }
  ...
  /**
    * @brief Destructs the VertexCatenaryFactor
    */ 
  ~VertexCatenaryFactor()
  {}
