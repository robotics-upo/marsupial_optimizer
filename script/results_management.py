...
output_file2.writelines(str(sM1[num_datas][1]/NE)+';'+str(sM1[num_datas][5]/NE)+';'+str(sM1[num_datas][6]/NE)+';'+str(sM1[num_datas][3]/NE)+';'+str(sM1[num_datas][4]/NE)+';'+str(sM1[num_datas][7]/NE)+';'+str(sM1[num_datas][8]/NE)+';'+str(sM1[num_datas][9]/NE)+';'+str(sM1[num_datas][10]/NE)+';'+str(sM2[num_datas][3]/NE)+';'+str(sM2[num_datas][4]/NE)+';'+str(sM2[num_datas][7]/NE)+';'+str(sM2[num_datas][8]/NE)+';'+str(sM2[num_datas][9]/NE)+';'+str(sM2[num_datas][10]/NE)+'\n')
output_file2.close()
