...
cat=[4.00000 -0.08750 0.00000 1.10000 -0.95000 6.10000 0.412 0.300 1.067]; %Posicion 36 catenary (coll car 36 - 38)
...
plot3(v_pts_par(:,1), v_pts_par(:,2), v_pts_par(:,3),'b')
hold on;
plot3(v_pts_cat(:,1), v_pts_cat(:,2), v_pts_cat(:,3),'r')
grid;